...
//	 }
	...
	public String updateUI(@PathVariable("id") Integer id, HttpSession session) {
		...
		List<Fenlei> slist = fenleiService.selectAll();
...
//	
//	
	@RequestMapping(value="/monsterss",method=RequestMethod.GET)
	public String selectFY(Integer pageNow, HttpServletRequest request){
		...
		PageBean<Fenlei> pb=fenleiService.showAllPagehelper(pageNow);
